...
\begin{abstract}
	\input{text/The Frontmatter/abstract}
\end{abstract}
%%%%% ACKNOWLEDGEMENTS -- Nothing to do here except comment out if you don't want it.
\begin{acknowledgements}
 	\input{text/The Frontmatter/acknowledgements}
...
\include{text/The Mainmatter/ch-01-Introduction}
%%% COMMENT OUT CHAPTERS TO NOT COMPILE THEM -> FASTER DRAFTING
% \include{text/The Mainmatter/ch-00-Conclusions}
\include{text/The Mainmatter/ch-02-Examples}
...
\startappendices
\include{text/The Appendices/appendix1}
\include{text/The Appendices/wordpagecount}
